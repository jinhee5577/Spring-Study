	    ...
	    <div class="panel-body mt-5">
	      <form action="boardUpdate.do" method="POST">
	    	...
	    	<table class="table table-hover">
		     <tr>
		     	<th>제목</th>
		     	<th><input value="${vo.title}" required="required" class="form-control" type="text" name="title" ></th>
		     </tr>	 	
		     <tr>
		     	<th>내용</th>
		     	<th><textarea name="content" class="form-control" rows="7" cols="">${vo.content}</textarea></th>
		     </tr>	 	
		     <tr>
		     	<th>작성자</th>
		     	<th><input value="${vo.writer}" required="required"  type="text" class="form-control"  name="writer" ></th>
		     </tr>
		     <tr>
